...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages: ["Anh yêu vợ", "mãi yêu vợ", "Thật sự yêu vợ rất nhiều đó", "Chúc vợ 20/10 thật xinh đẹp, hạnh phúc và luôn được yêu như hôm nay", "Vợ là điều tuyệt vời nhất"],
      images: [],
      heartColor: "#ff9090",
    },
  };
